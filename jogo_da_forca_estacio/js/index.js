...
function mudarStyleLetra(tecla, condicao){
    if(condicao == false)
    {
        document.getElementById(tecla).style.background = "#871313";
...
function comparalistas(letra){
    ...
    if(pos < 0){
        ...
        if(tentativas == 0){
            abreModal("OPS!", "Você perdeu ... A palavra era: <br>" + palavraSecretaSorteada);
...
function carregaImagemForca(){
    switch(tentativas){
        case 5:
            ...
            break;
        case 4:
            document.getElementById("imagem").style.background  = "url('./img/cabe_tronco.png')";
            break;
        case 3:
            document.getElementById("imagem").style.background  = "url('./img/cabe_tronco_braco.png')";
            break;
        case 2:
            document.getElementById("imagem").style.background  = "url('./img/cabeca_tronco_braco2.png')";
            break;
        case 1:
            document.getElementById("imagem").style.background  = "url('./img/cabeca_tronco_braco_perna.png')";
            break;
        case 0:
            document.getElementById("imagem").style.background  = "url('./img/corpo_completo.png')";
            break;
        default:
